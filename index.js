...
for(let i=0;i<10;i++){
	for(let j=0;j<10;j++){
       ...
       document.getElementsByTagName("td")[counter].setAttribute("onmouseout","returnOriginColor(this)");
       ...
       if(i===0){
       	...
       	document.getElementsByTagName("td")[counter].style.height="34px";
       	if(j===0)
       ...
       if(j===9){
       		...
       		document.getElementsByTagName("td")[counter].style.width="34px";
       		if(i===0)
